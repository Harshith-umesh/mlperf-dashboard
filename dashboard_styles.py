...
def get_light_mode_css():
    ...
    button[title*="Reset"], button[title*="Clear"] {
        background-color: #ffffff !important;
        color: #262730 !important;
        border: 1px solid #d1d5db !important;
    }
...
def inject_mlperf_css():
    """Inject CSS styles for MLPerf dashboard.
    
    This function injects the base app CSS and applies theme-specific CSS.
